...
class HRNet(nn.Module):
    def __init__(self, c=48, nof_joints=21, bn_momentum=0.1):
...
if __name__ == '__main__':
    ...
    model = HRNet(32, 21, 0.1)

    pretrained_dict = torch.load('./pose_hrnet_w32_256x192.pth')
    pretrained_dict = {k: v for k, v in pretrained_dict.items() if 'final_layer' not in k}
